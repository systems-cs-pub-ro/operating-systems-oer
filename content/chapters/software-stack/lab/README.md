...
```Bash
student@os:~/.../software-stack/lab/basic-syscall$ ls
hello.asm  hello.s  Makefile

student@os:~/.../software-stack/lab/basic-syscall$ make
...
student@os:~/.../software-stack/lab/basic-syscall$ ./hello-nasm
Hello, world!
student@os:~/.../software-stack/lab/basic-syscall$ ./hello-gas
Hello, world!
```
...
```Bash
student@os:~/.../software-stack/lab/basic-syscall$ strace ./hello-nasm
...
```Bash
razvan@yggdrasil:~/.../software-stack/lab/syscall-wrapper$ ls
main.c  Makefile  syscall.h  syscall.s

razvan@yggdrasil:~/.../software-stack/lab/syscall-wrapper$ make
...
razvan@yggdrasil:~/.../software-stack/lab/syscall-wrapper$ ./main
Hello, world!

razvan@yggdrasil:~/.../software-stack/lab/syscall-wrapper$ strace ./main
